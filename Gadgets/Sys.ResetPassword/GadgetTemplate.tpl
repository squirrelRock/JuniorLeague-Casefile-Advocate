...
<div id="passwordMeterContainer"></div>
                                ...
                                <span validatorType="OldPasswordReuse" errorMessage="<$Model.Text.InvalidOldPasswordReuse$>" controlToValidate="ctl00_ContentArea_NewPasswordTextBox" id="ctl00_ContentArea_InvalidOldPasswordReuseCv" class="validationError" style="display: <$if(Model.Result.InvalidOldPasswordReuse)$>inline-block<$else$>none<$endif$>;">
                                    <$Model.Text.InvalidOldPasswordReuse$>
                                </span>
                            </div>
                            </td>
                        </tr>
