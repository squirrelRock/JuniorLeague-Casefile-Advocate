(function (window, WA, undefined)
{
  ...
  if (!window.WaHeadlineGadgetResizer)
  {
    window.WaHeadlineGadgetResizer = WaHeadlineGadgetResizer;
  }

  function WaHeadlineGadgetResizer(initModel)
  {
    var pThis = this,
        typeName = 'WaHeadlineGadgetResizer',
        viewModel = initModel;
    ...
    function setEditableContainerHeight()
    {
      ...
      var gadgetHeight = container.offsetHeight - WA.Style.getElementStyleInt(container, 'paddingBottom', window),
          ...
          heightMeter = document.createElement('waHeadlineHeightMeter'),
