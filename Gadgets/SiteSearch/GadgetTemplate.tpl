	...
	<div class="searchBoxOuter align<$Model.Settings.Align$>">
		...
		<$control.Form(formBegin = "true", action = Model.Urls.Search, id = Model.Id + "_form", class="generalSearchBox")$>
			<span class="searchBoxFieldContainer">
				<input class="searchBoxField" type="text" name="searchString" id="id<$Model.Id$>_searchBox" value="" maxlength="300" <$if(Model.Settings.ShowAutosuggestion)$>autocomplete="off"<$endif$> placeholder="<$Model.Settings.SearchPrompt$>">
				<a class="searchBoxButton" id="id<$Model.Id$>_searchButton">Search</a>
			</span>
	...
	<script type="text/javascript">
		(function(){
			...
			function init()
			{
				...
				model.searchBoxButton = 'id<$Model.Id$>_searchButton';
