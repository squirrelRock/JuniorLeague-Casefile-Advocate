...
<div id="passwordMeterContainer"></div>
														...
														<$endif$>
														<$if(Model.Result.InvalidOldPasswordReuse)$>
															<span validatorType="passwordStrength" errorMessage="<$Model.Text.InvalidOldPasswordReuse$>" controlToValidate="ctl00_ContentArea_NewPasswordTextBox" id="ctl00_ContentArea_InvalidOldPasswordReuseCustomValidator" class="validationError" style="display: <$if(Model.Result.InvalidOldPasswordReuse)$>inline-block<$else$>none<$endif$>;">
