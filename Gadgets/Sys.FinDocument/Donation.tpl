    ...
    <$endif$>
			...
			<div class="formContainer">
				<div class="generalFieldsContainer">
					<div class="fieldContainer simpleTextContainer" align="right">
						<$if (Model.Pdf.IsAvailable)$>
					  	<a href="<$Model.Pdf.DownloadLink$>"><$Model.Pdf.LinkLabel$></a>
						<$endif$>
					</div>
					...
					<$control.FormHelpers (sectionStart="true")$>
                        ...
                        <$if (Model.DonationDetails.ShowPaymentMethodId)$>
						    <$control.FormHelpers (simpleText="true", name=Model.DonationDetails.Text.PaymentMethodIdLabel, value=Model.DonationDetails.PaymentMethodId)$>
                        <$endif$>
