			...
			<div class="formContainer">
				<div class="generalFieldsContainer">
					...
					<$control.FormHelpers (sectionStart="true")$>
                        ...
                        <$if (Model.PaymentDetails.ShowPaymentMethodId)$>
						    <$control.FormHelpers (simpleText="true", name=Model.PaymentDetails.Text.PaymentMethodIdLabel, value=Model.PaymentDetails.PaymentMethodId)$>
                        <$endif$>
